...
{
    public class CommentCreatedEventConsumer(PostDbContext dbContext, ISendEndpointProvider sendEndpointProvider, IInboxService<CommentCreatedEvent> commentInboxService) : IConsumer<CommentCreatedEvent>
    {
